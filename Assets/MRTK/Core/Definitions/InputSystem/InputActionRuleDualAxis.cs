...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public struct InputActionRuleDualAxis : IInputActionRule<Vector2>
    {
        ...
        public InputActionRuleDualAxis(MixedRealityInputAction baseAction, MixedRealityInputAction ruleAction, Vector2 criteria)
        {
            ...
            this.criteriaRule = new InputActionRuleCriteriaDualAxis(criteria);
        }
        ...
        private InputActionRuleCriteriaDualAxis criteriaRule;
        
        /// <inheritdoc />
        public IInputActionRuleCriteria<Vector2> CriteriaRule => criteriaRule;
    }
}